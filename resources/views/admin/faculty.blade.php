...
@section('title', __('faculty'))
@section('content')
    <div class="pb-4">
        <div class="flex items-center">
            <button id="add_btn"
                class="text-sm p-2 text-gray-700 bg-white border dark:bg-gray-800 border-gray-300 hover:bg-gray-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg dark:text-gray-400 dark:hover:text-white dark:focus:ring-gray-800 dark:border-gray-600">
