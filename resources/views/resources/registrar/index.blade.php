    ...
    <div class="pt-4">
        ...
        <nav class="flex justify-between items-center" aria-label="Table navigation">
            ...
            <ul class="inline-flex items-center -space-x-px">
                ...
                @foreach (range(1, $data->count()) as $item)
                    <li>
                ...
                <li>
                    <a href="{{ $data->nextPageUrl() }}" @disabled(!$data->nextPageUrl())
                        class="block py-2 px-2 leading-tight text-gray-700 bg-white rounded-r-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
